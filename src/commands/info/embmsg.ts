...
export default new Command({
  ...
  run: async ({ interaction }) => {
    ...
    const embed = new MessageEmbed()
        .setColor('#0099ff')
        .setTitle(title)
        .setAuthor({name: `${interaction.user.username}`, iconURL: `${avatar}` , url: 'https://discord.js.org' })
        .setThumbnail('https://w7.pngwing.com/pngs/413/620/png-transparent-gratitude-autocad-dxf-blessing-love-others-love-miscellaneous-text-thumbnail.png')
